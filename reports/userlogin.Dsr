VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptuserlogin 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "school - rptuserlogin (DataReport)"
   ClientHeight    =   7380
   ClientLeft      =   120
   ClientTop       =   2085
   ClientWidth     =   11985
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Login Date &  Time"
         Alignment       =   2
      EndProperty
      ItemType3       =   5
   ...
   EndProperty
End
Attribute VB_Name = "rptuserlogin"
