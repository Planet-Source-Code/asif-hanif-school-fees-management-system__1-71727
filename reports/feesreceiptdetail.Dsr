VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptfeesreceiptdetail 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "school - rptfeesreceiptdetail (DataReport)"
   ClientHeight    =   8760
   ClientLeft      =   90
   ClientTop       =   1650
   ClientWidth     =   12405
   ...
   EndProperty
End
Attribute VB_Name = "rptfeesreceiptdetail"
